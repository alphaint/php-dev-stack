...
$sites['local.leadershipweek.alpha.org']  = 'leadershipweek.alpha.org';
$sites['local.htb.org.uk']            	  = 'htb.org.uk';
$sites['sandbox.org']            		  = 'sandbox.org';
$sites['local.kingdomcome.alpha.org ']    = 'kingdomcome.alpha.org';
$sites['xa-es.local.alpha.org ']          = 'alpha.org';
$sites['local.alpha.org']                 = 'brand2013.alpha.org';
$sites['local.run.alpha.org']             = 'alpha.org';
$sites['local.acs.alpha.org']             = 'acs.alpha.org';
$sites['local.regent.alpha.org']          = 'regent.alpha.org';
